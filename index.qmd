...
::: callout-warning
## TO DO: Replace it with interactive figures.
:::

::: {#fig-preimage-matching-points-interactive}
![](plots/projection_multi_horizontal.png)

Interactive figures of the simplex projection $\Phi$ for a set of points $\{x^{(l)}\}$ (Coming soon).
:::
